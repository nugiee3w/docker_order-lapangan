<?php $__env->startSection('title', 'Tambah Pemesanan Baru'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php if(!empty($lapangan_list)): ?>
                                        <?php $__currentLoopData = $lapangan_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lapangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($lapangan['id']); ?>" 
                                                    data-harga="<?php echo e((float)$lapangan['harga_per_jam']); ?>"
                                                    <?php echo e(old('lapangan_id') == $lapangan['id'] ? 'selected' : ''); ?>>
                                                <?php echo e($lapangan['nama']); ?> - <?php echo e(ucfirst($lapangan['jenis'])); ?> 
                                                (Rp <?php echo e(number_format((float)$lapangan['harga_per_jam'], 0, ',', '.')); ?>/jam)
                                            </option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control <?php $__errorArgs = ['tanggal_booking'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       id="tanggal_booking" name="tanggal_booking" value="<?php echo e(old('tanggal_booking')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control <?php $__errorArgs = ['jam_mulai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="06:00" <?php echo e(old('jam_mulai') == '06:00' ? 'selected' : ''); ?>>06:00 - Jam 6 Pagi</option>
                                    <option value="07:00" <?php echo e(old('jam_mulai') == '07:00' ? 'selected' : ''); ?>>07:00 - Jam 7 Pagi</option>
                                    <option value="08:00" <?php echo e(old('jam_mulai') == '08:00' ? 'selected' : ''); ?>>08:00 - Jam 8 Pagi</option>
                                    <option value="09:00" <?php echo e(old('jam_mulai') == '09:00' ? 'selected' : ''); ?>>09:00 - Jam 9 Pagi</option>
                                    <option value="10:00" <?php echo e(old('jam_mulai') == '10:00' ? 'selected' : ''); ?>>10:00 - Jam 10 Pagi</option>
                                    <option value="11:00" <?php echo e(old('jam_mulai') == '11:00' ? 'selected' : ''); ?>>11:00 - Jam 11 Pagi</option>
                                    <option value="12:00" <?php echo e(old('jam_mulai') == '12:00' ? 'selected' : ''); ?>>12:00 - Jam 12 Siang</option>
                                    <option value="13:00" <?php echo e(old('jam_mulai') == '13:00' ? 'selected' : ''); ?>>13:00 - Jam 1 Siang</option>
                                    <option value="14:00" <?php echo e(old('jam_mulai') == '14:00' ? 'selected' : ''); ?>>14:00 - Jam 2 Siang</option>
                                    <option value="15:00" <?php echo e(old('jam_mulai') == '15:00' ? 'selected' : ''); ?>>15:00 - Jam 3 Sore</option>
                                    <option value="16:00" <?php echo e(old('jam_mulai') == '16:00' ? 'selected' : ''); ?>>16:00 - Jam 4 Sore</option>
                                    <option value="17:00" <?php echo e(old('jam_mulai') == '17:00' ? 'selected' : ''); ?>>17:00 - Jam 5 Sore</option>
                                    <option value="18:00" <?php echo e(old('jam_mulai') == '18:00' ? 'selected' : ''); ?>>18:00 - Jam 6 Sore</option>
                                    <option value="19:00" <?php echo e(old('jam_mulai') == '19:00' ? 'selected' : ''); ?>>19:00 - Jam 7 Malam</option>
                                    <option value="20:00" <?php echo e(old('jam_mulai') == '20:00' ? 'selected' : ''); ?>>20:00 - Jam 8 Malam</option>
                                    <option value="21:00" <?php echo e(old('jam_mulai') == '21:00' ? 'selected' : ''); ?>>21:00 - Jam 9 Malam</option>
                                    <option value="22:00" <?php echo e(old('jam_mulai') == '22:00' ? 'selected' : ''); ?>>22:00 - Jam 10 Malam</option>
                                    <option value="23:00" <?php echo e(old('jam_mulai') == '23:00' ? 'selected' : ''); ?>>23:00 - Jam 11 Malam</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control <?php $__errorArgs = ['jam_selesai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="07:00" <?php echo e(old('jam_selesai') == '07:00' ? 'selected' : ''); ?>>07:00 - Jam 7 Pagi</option>
                                    <option value="08:00" <?php echo e(old('jam_selesai') == '08:00' ? 'selected' : ''); ?>>08:00 - Jam 8 Pagi</option>
                                    <option value="09:00" <?php echo e(old('jam_selesai') == '09:00' ? 'selected' : ''); ?>>09:00 - Jam 9 Pagi</option>
                                    <option value="10:00" <?php echo e(old('jam_selesai') == '10:00' ? 'selected' : ''); ?>>10:00 - Jam 10 Pagi</option>
                                    <option value="11:00" <?php echo e(old('jam_selesai') == '11:00' ? 'selected' : ''); ?>>11:00 - Jam 11 Pagi</option>
                                    <option value="12:00" <?php echo e(old('jam_selesai') == '12:00' ? 'selected' : ''); ?>>12:00 - Jam 12 Siang</option>
                                    <option value="13:00" <?php echo e(old('jam_selesai') == '13:00' ? 'selected' : ''); ?>>13:00 - Jam 1 Siang</option>
                                    <option value="14:00" <?php echo e(old('jam_selesai') == '14:00' ? 'selected' : ''); ?>>14:00 - Jam 2 Siang</option>
                                    <option value="15:00" <?php echo e(old('jam_selesai') == '15:00' ? 'selected' : ''); ?>>15:00 - Jam 3 Sore</option>
                                    <option value="16:00" <?php echo e(old('jam_selesai') == '16:00' ? 'selected' : ''); ?>>16:00 - Jam 4 Sore</option>
                                    <option value="17:00" <?php echo e(old('jam_selesai') == '17:00' ? 'selected' : ''); ?>>17:00 - Jam 5 Sore</option>
                                    <option value="18:00" <?php echo e(old('jam_selesai') == '18:00' ? 'selected' : ''); ?>>18:00 - Jam 6 Sore</option>
                                    <option value="19:00" <?php echo e(old('jam_selesai') == '19:00' ? 'selected' : ''); ?>>19:00 - Jam 7 Malam</option>
                                    <option value="20:00" <?php echo e(old('jam_selesai') == '20:00' ? 'selected' : ''); ?>>20:00 - Jam 8 Malam</option>
                                    <option value="21:00" <?php echo e(old('jam_selesai') == '21:00' ? 'selected' : ''); ?>>21:00 - Jam 9 Malam</option>
                                    <option value="22:00" <?php echo e(old('jam_selesai') == '22:00' ? 'selected' : ''); ?>>22:00 - Jam 10 Malam</option>
                                    <option value="23:00" <?php echo e(old('jam_selesai') == '23:00' ? 'selected' : ''); ?>>23:00 - Jam 11 Malam</option>
                                    <option value="00:00" <?php echo e(old('jam_selesai') == '00:00' ? 'selected' : ''); ?>>00:00 - Jam 12 Malam (Hari Berikutnya)</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="total_harga" name="total_harga" value="<?php echo e(old('total_harga')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="unpaid" <?php echo e(old('payment_status') == 'unpaid' ? 'selected' : ''); ?>>Belum Dibayar</option>
                                    <option value="paid" <?php echo e(old('payment_status') == 'paid' ? 'selected' : ''); ?>>Sudah Dibayar</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                          id="notes" name="notes" rows="3" placeholder="Masukkan catatan tambahan jika diperlukan..."><?php echo e(old('notes')); ?></textarea>
...
async function fetchAvailableTimeSlots() {
    ...
    try {
        ...
        const apiUrl = `<?php echo e(route('api.available-time-slots')); ?>?lapangan_id=${lapanganSelect.value}&tanggal_booking=${tanggalBooking.value}`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/orders/create.blade.php ENDPATH**/ ?>