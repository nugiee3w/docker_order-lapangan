<?php $__env->startSection('title', 'Detail Pemesanan #' . $order->order_number); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-file-alt text-info"></i> Detail Pemesanan #<?php echo e($order->order_number); ?>
                        ...
                        <div class="col-md-6">
                            <div class="text-center">
                                <div class="btn-group-vertical" role="group">
                                    <a href="mailto:<?php echo e($order->customer_email); ?>" class="btn btn-outline-primary btn-sm">
                                        <i class="fas fa-envelope"></i> Kirim Email
                                    </a>
                                    <a href="tel:<?php echo e($order->customer_phone); ?>" class="btn btn-outline-success btn-sm">
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td>
                                        <div class="font-weight-bold text-primary"><?php echo e($order->lapangan_info['nama'] ?? 'N/A'); ?></div>
                                        <small class="text-muted"><?php echo e($order->lapangan_info['jenis'] ?? 'N/A'); ?></small>
                                    </td>
                                </tr>
                                <tr>
                                    <td><strong>Lokasi:</strong></td>
                                    <td><?php echo e($order->lapangan_info['lokasi'] ?? 'N/A'); ?></td>
                                </tr>
                                <?php if(isset($order->lapangan_info['status'])): ?>
                                <tr>
                                    <td><strong>Status Lapangan:</strong></td>
                                    <td>
                                        <span class="badge badge-success"><?php echo e($order->lapangan_info['status']); ?></span>
                                    </td>
                                </tr>
                                <?php endif; ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="font-weight-bold">
                                            <?php echo e($order->tanggal_booking->format('d/m/Y')); ?>

                                        </span>
                                        <small class="text-muted">
                                            (<?php echo e($order->tanggal_booking->translatedFormat('l')); ?>)
                                        </small>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-info badge-pill">
                                            <?php echo e($order->jam_mulai); ?> - <?php echo e($order->jam_selesai); ?>
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td>Rp <?php echo e(number_format($order->lapangan_info['harga_per_jam'] ?? 0, 0, ',', '.')); ?></td>
                                </tr>
                                <tr>
                                ...
                                <?php if(!empty($order->lapangan_info['fasilitas'])): ?>
                                <tr>
                                    <td><strong>Fasilitas:</strong></td>
                                    <td>
                                        <?php $__currentLoopData = $order->lapangan_info['fasilitas']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fasilitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="badge badge-secondary badge-sm"><?php echo e($fasilitas); ?></span>
                    ...
                    <form action="<?php echo e(route('orders.updateStatus', $order->id)); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" id="payment_status" name="payment_status">
                                <option value="unpaid" <?php echo e($order->payment_status == 'unpaid' ? 'selected' : ''); ?>>Belum Dibayar</option>
                                <option value="paid" <?php echo e($order->payment_status == 'paid' ? 'selected' : ''); ?>>Sudah Dibayar</option>
                            </select>
                        </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('orders.edit', $order->id)); ?>" class="btn btn-warning btn-sm">
                        ...
                        <a href="<?php echo e(route('orders.create')); ?>" class="btn btn-success btn-sm">
                            <i class="fas fa-plus"></i> Order Baru
                        </a>
                        
                        <a href="mailto:<?php echo e($order->customer_email); ?>?subject=Konfirmasi Booking <?php echo e($order->order_number); ?>" 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menghapus order <strong>#<?php echo e($order->order_number); ?></strong>?</p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/orders/show.blade.php ENDPATH**/ ?>