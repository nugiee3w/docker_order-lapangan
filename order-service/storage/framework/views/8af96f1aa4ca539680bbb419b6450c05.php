...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard - Booking Lapangan'); ?></title>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('orders.*') ? 'active fw-bold' : ''); ?>" 
                        ...
                        <ul class="dropdown-menu shadow border-0" aria-labelledby="ordersDropdown">
                            ...
                            <li>
                                <a class="dropdown-item <?php echo e(request()->routeIs('orders.index') ? 'active' : ''); ?>" 
                            ...
                            <li>
                                <a class="dropdown-item <?php echo e(request()->routeIs('orders.create') ? 'active' : ''); ?>" 
                                   href="<?php echo e(route('orders.create')); ?>">
                            ...
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('orders.index', ['status' => 'pending'])); ?>">
                                    <i class="fas fa-clock me-2 text-warning"></i>
                                    Pending
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('orders.index', ['status' => 'confirmed'])); ?>">
                                    <i class="fas fa-check me-2 text-success"></i>
                                    Confirmed
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('orders.index', ['payment_status' => 'unpaid'])); ?>">
                    ...
                    <!-- Lapangan -->
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('lapangan.*') ? 'active fw-bold' : ''); ?>" href="<?php echo e(route('lapangan.index')); ?>">
    ...
    <footer class="bg-white py-4 mt-5 border-top">
        <div class="container-fluid">
            <div class="copyright text-center">
                <span class="text-muted">Copyright &copy; Sport Court Admin <?php echo e(date('Y')); ?></span>
            </div>
        </div>
    </footer>
