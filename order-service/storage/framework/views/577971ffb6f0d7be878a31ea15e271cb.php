...
<?php $__env->startSection('title', 'Pilih Lapangan - Order Service'); ?>
...
<div class="row">
    <?php $__empty_1 = true; $__currentLoopData = $lapangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lapangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="card shadow h-100">
            ...
            <div class="card-header p-0">
                <div class="position-relative">
                    <?php if(isset($lapangan['image']) && $lapangan['image']): ?>
                        <img src="<?php echo e($lapangan['image']); ?>" class="card-img-top" style="height: 200px; object-fit: cover;" alt="<?php echo e($lapangan['nama']); ?>" loading="lazy" 
                    ...
                    <div class="position-absolute top-0 start-0 m-2">
                        <span class="badge 
                            ...
                            <?php elseif($lapangan['jenis'] == 'voli'): ?> bg-info
                            <?php elseif($lapangan['jenis'] == 'tennis'): ?> bg-secondary
                            <?php else: ?> bg-info
                            <?php endif; ?>
                        ">
                            <?php if($lapangan['jenis'] == 'futsal'): ?>
                            ...
                            <?php endif; ?>
                            <?php echo e(ucfirst($lapangan['jenis'])); ?>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <h5 class="card-title mb-0 fw-bold"><?php echo e($lapangan['nama']); ?></h5>
                    <div class="text-end">
                        <div class="text-success fw-bold">Rp <?php echo e(number_format($lapangan['harga_per_jam'], 0, ',', '.')); ?></div>
                        <small class="text-muted">per jam</small>
                    </div>
                </div>

                <p class="card-text text-muted mb-3"><?php echo e($lapangan['deskripsi'] ?? 'Tidak ada deskripsi'); ?></p>

                <div class="mb-3">
                    <small class="text-muted d-block">
                        <i class="fas fa-map-marker-alt me-1"></i><?php echo e($lapangan['lokasi']); ?>
                    ...
                    <div class="row text-center">
                        <div class="col-6">
                            <div class="border-end">
                                <div class="fw-bold text-primary"><?php echo e($lapangan['total_orders'] ?? 0); ?></div>
                                <small class="text-muted">Total Pesanan</small>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="fw-bold text-success"><?php echo e(count($lapangan['recent_orders'] ?? [])); ?></div>
                ...
                <?php if(isset($lapangan['recent_orders']) && count($lapangan['recent_orders']) > 0): ?>
                <div class="mb-3">
                    <small class="text-muted d-block mb-2">Pesanan Terbaru:</small>
                    <div class="list-group list-group-flush">
                        <?php $__currentLoopData = array_slice($lapangan['recent_orders']->toArray(), 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-group-item px-0 py-1 border-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <small class="fw-medium"><?php echo e($order['customer_name']); ?></small>
                                    <br>
                                    <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($order['tanggal_booking'])->format('d M')); ?> - <?php echo e($order['jam_mulai']); ?></small>
                                </div>
                                <span class="badge 
            ...
            <div class="card-footer bg-transparent">
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('lapangan.show', $lapangan['id'])); ?>" class="btn btn-primary">
                        <i class="fas fa-eye me-2"></i>Lihat Detail & Pesanan
                    </a>
                    <?php if($lapangan['status'] == 'tersedia'): ?>
                        <a href="<?php echo e(route('orders.create', ['lapangan_id' => $lapangan['id']])); ?>" class="btn btn-outline-success btn-sm">
