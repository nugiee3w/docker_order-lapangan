...
@section('title', 'Dashboard - Lapangan Service')
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        <h3 class="fw-bold text-primary mb-1">{{ $totalLapangan }}</h3>
    ...
    <div class="col-lg-4 col-md-6 mb-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        <h3 class="fw-bold text-success mb-1">{{ $totalOrders }}</h3>
    ...
    <div class="col-lg-4 col-md-6 mb-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        <h3 class="fw-bold text-warning mb-1">{{ $totalHours }}</h3>
                ...
                <div class="row g-3">
                    <div class="col-4">
                        <div class="text-center">
                            ...
                            <h4 class="fw-bold text-primary mb-1">{{ $totalLapangan }}</h4>
                    ...
                    <div class="col-4">
                        <div class="text-center">
                            ...
                            <h4 class="fw-bold text-warning mb-1">{{ $totalHours }}</h4>
