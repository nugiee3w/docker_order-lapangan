...
<?php $__env->startSection('title', 'Jadwal Lapangan - Booking Lapangan'); ?>
...
<div class="filter-section">
    <form method="GET" action="<?php echo e(route('jadwal')); ?>">
        <div class="row">
            <div class="col-md-3">
                <label for="jenis" class="form-label">Jenis Lapangan</label>
                <select name="jenis" id="jenis" class="form-select">
                    <option value="">Semua Jenis</option>
                    <option value="futsal" <?php echo e(request('jenis') == 'futsal' ? 'selected' : ''); ?>>Futsal</option>
                    <option value="badminton" <?php echo e(request('jenis') == 'badminton' ? 'selected' : ''); ?>>Badminton</option>
                    <option value="basket" <?php echo e(request('jenis') == 'basket' ? 'selected' : ''); ?>>Basket</option>
                    <option value="tenis_meja" <?php echo e(request('jenis') == 'tenis_meja' ? 'selected' : ''); ?>>Tenis Meja</option>
                </select>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <select name="status" id="status" class="form-select">
                    ...
                    <option value="dipesan" <?php echo e(request('status') == 'dipesan' ? 'selected' : ''); ?>>Dipesan</option>
                    <option value="sedang_digunakan" <?php echo e(request('status') == 'sedang_digunakan' ? 'selected' : ''); ?>>Sedang Digunakan</option>
            ...
            <div class="col-md-3 d-flex align-items-end">
                ...
                <a href="<?php echo e(route('jadwal')); ?>" class="btn btn-outline-secondary">
...
<div class="row">
    ...
    <div class="col-md-6 col-lg-4 mb-4">
        <div class="card h-100 <?php echo e($jadwal->status == 'tersedia' ? 'border-success' : ($jadwal->status == 'dipesan' ? 'border-warning' : 'border-secondary')); ?>">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="mb-0"><?php echo e($jadwal->lapangan->nama); ?></h6>
                <span class="badge jenis-badge
                    <?php if($jadwal->lapangan->jenis == 'futsal'): ?> bg-primary
                    <?php elseif($jadwal->lapangan->jenis == 'badminton'): ?> bg-success
                    <?php elseif($jadwal->lapangan->jenis == 'basket'): ?> bg-warning
                    <?php else: ?> bg-info
                    <?php endif; ?>
                ">
                    <?php echo e(ucfirst($jadwal->lapangan->jenis)); ?>
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <span><?php echo e(\Carbon\Carbon::parse($jadwal->tanggal)->format('d M Y')); ?></span>
                </div>
                
                <div class="mb-3">
                    <strong><i class="fas fa-clock me-2"></i>Waktu:</strong>
                    <span class="fw-bold"><?php echo e($jadwal->jam_mulai); ?> - <?php echo e($jadwal->jam_selesai); ?></span>
                </div>
                
                <div class="mb-3">
                    <strong><i class="fas fa-money-bill me-2"></i>Harga:</strong>
                    <span class="text-success fw-bold">Rp <?php echo e(number_format($jadwal->harga, 0, ',', '.')); ?></span>
                </div>
                
                <div class="mb-3">
                    <strong><i class="fas fa-map-marker-alt me-2"></i>Lokasi:</strong>
                    <span><?php echo e($jadwal->lapangan->lokasi); ?></span>
                </div>
                
                <div class="mb-3">
                    <strong><i class="fas fa-info-circle me-2"></i>Status:</strong>
                    <span class="badge status-badge 
                        <?php if($jadwal->status == 'tersedia'): ?> bg-success
                        <?php elseif($jadwal->status == 'dipesan'): ?> bg-warning
                        <?php elseif($jadwal->status == 'sedang_digunakan'): ?> bg-info
                        <?php else: ?> bg-secondary
                        <?php endif; ?>
                    ">
                        <?php echo e(ucfirst(str_replace('_', ' ', $jadwal->status))); ?>
            ...
            <div class="card-footer">
                <div class="d-grid gap-2">
                    <?php if($jadwal->status == 'tersedia'): ?>
                        <button class="btn btn-success btn-sm" onclick="bookingInfo(<?php echo e($jadwal->id); ?>)">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/jadwal/index.blade.php ENDPATH**/ ?>